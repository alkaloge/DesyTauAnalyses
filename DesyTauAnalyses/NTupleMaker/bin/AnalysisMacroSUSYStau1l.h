...
TH1D *hel_relISO[CutNumb];
TH1D *hmu_relISO[CutNumb];
TH2D *hmet_MT[CutNumb];
TH2D *hmet_dPhi[CutNumb];
TH2D *hMT_dPhi[CutNumb];
...
//void FillMainHists(int CutIndex, Double_t EvWeight, vector<TLorentzVector>  *ElV, vector<TLorentzVector>  *MuV,vector<TLorentzVector>  *JetsV,Float_t METV,tree){
